    ...
    void OnTriggerEnter2D(Collider2D coll) 
	{
        ...
        if (own.gameObject.tag == Tag.REMOTEPLAYERBODY)
        {
            ...
            if(coll.tag == Tag.LOCALPLAYERBODY)
            {
                ...
                coll.GetComponent<TankObject>().PlayerGO.GetComponent<TankStore>().tankCamera.GetComponent<Shake>().CamShake();
                //i robię BOOM!
        ...
        {
            //own.GetComponent<TankStore>().tankCamera.GetComponent<Shake>().CamShake();
